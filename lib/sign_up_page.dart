...
// import 'package:flutter/material.dart';
// import 'package:exercise_app/exercise_selection_page.dart'; // Import the new page
...
//           child: Column(
//             children: [
//               // Welcome text with a slight shadow
//               Text(
//                 'Create Your Account',
//                 style: TextStyle(
//                   fontSize: 24,
...
//               // Card to hold the sign-up form for a modern UI
//               Card(
//                 elevation: 8.0,
//                 shape: RoundedRectangleBorder(
...
//                           onPressed: () {
//                             if (_formKey.currentState?.validate() ?? false) {
//                               // Form is valid, navigate to ExerciseSelectionPage
//                               Navigator.pushReplacement(
//                                 context,
//                                 MaterialPageRoute(
//                                     builder: (context) =>
